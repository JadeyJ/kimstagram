    ...
    <header class="profile__header">
      ...
      <div class="profile__info">
        <div class="profile__title">
          ...
          <c:if test="${principal.user.id ne user.id}">
          	<c:choose>
          	 <c:when test="${followCheck eq 1}">
       			<button onClick="follow(false, ${user.id})" class="profile_edit_btn">Following</button>
           	 </c:when>
           	 <c:otherwise>
          ...
          <a href="/image/upload">
            <button class="profile_follow_btn">Upload Post</button>
          </a>
        ...
        <ul class="profile__stats">
          ...
          <li class="profile__stat">
            <a href="/follow/follower/${user.id}"><span class="profile__stat-number">4,444 </span>followers</a>
          </li>
          <li class="profile__stat">
            <a href="/follow/following/${user.id}"><span class="profile__stat-number">44 </span>following</a>
          </li>
        </ul>
